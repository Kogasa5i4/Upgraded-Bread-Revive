    ...
    public static class ServerConfig {
        ...
        public ServerConfig(ForgeConfigSpec.Builder builder) {
            ...
            healthBreadDefaultLevel = builder
                    .comment("默认生命增加等级（0-255，0表示增加半颗心），默认为0")
                    .comment("*可能会导致效果超模")
                    .defineInRange("defaultLevel", 0, 0, 255);
            ...
            healthBreadMaxLevel = builder
                    .comment("最大等级（0-255，0表示增加1颗心），默认为255")
                    .comment("*可能会导致效果超模")
            ...
            healthBreadAbsorptionLevel = builder
                    .comment("伤害吸收等级（0-255），默认为2")
                    .comment("*可能会导致效果超模")
                    .defineInRange("absorptionLevel", 2, 0, 255);
